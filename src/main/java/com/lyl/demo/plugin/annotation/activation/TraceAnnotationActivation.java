...
package com.lyl.demo.plugin.annotation.activation;
...
public class TraceAnnotationActivation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String TRACE_ANNOTATION_METHOD_INTERCEPTOR = "com.lyl.demo.plugin.annotation.activation.TraceAnnotationMethodInterceptor";
    public static final String TRACE_ANNOTATION = "com.lyl.demo.plugin.annotation.Trace";
