...
public class ActiveSpanTagActivation extends ClassStaticMethodsEnhancePluginDefine {
    ...
    public static final String ENHANCE_CLASS = "com.lyl.demo.plugin.annotation.ActiveSpan";
    public static final String INTERCEPTOR_CLASS = "com.lyl.demo.plugin.annotation.activation.ActiveSpanTagInterceptor";
